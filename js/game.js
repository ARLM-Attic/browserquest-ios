    ...
    var Game = Class.extend({
        init: function (app) {
            ...
            this.spriteNames = ["hand", "sword", "loot", "target", "talk", "sparks", "shadow16", "rat", "skeleton", "skeleton2", "spectre", "boss", "deathknight", 
                                ...
                                "sorcerer", "octocat", "beachnpc", "forestnpc", "desertnpc", "lavanpc", "pvpnpc", "clotharmor", "leatherarmor", "mailarmor",
                                "platearmor", "redarmor", "goldenarmor", "platinumarmor", "firefox", "death", "sword1", "axe", "chest",
                                "sword2", "redsword", "bluesword", "goldensword", "platinumsword", "item-sword2", "item-axe", "item-redsword", "item-bluesword", "item-goldensword", "item-platinumsword", "item-leatherarmor", "item-mailarmor",
                                "item-platearmor", "item-redarmor", "item-goldenarmor", "item-platinumarmor", "item-flask", "item-cake", "item-burger", "morningstar", "item-morningstar", "item-firepotion"];

            this.pvpTimeStarted = new Date();
            this.pvpTimeLeft = 0;
            this.redkills = 0;
            this.bluekills = 0;
            this.minPvpLevel = 0;
            this.pvpFinished = false;
        },
        ...
        loadMap: function() {
        	...
        	this.map.ready(function() {
                log.info("Map loaded.");
                var tilesetIndex = self.renderer.upscaledRendering ? 0 : self.renderer.imagescale - 1;
        ...
        initPlayer: function() {
            if(this.storage.hasAlreadyPlayed()) {
                ...
                if (this.storage.data.player.level !== undefined) {
                    this.player.setLevel(this.storage.data.player.level);
                }
                if (this.storage.data.player.xp !== undefined) {
                    this.player.setXP(this.storage.data.player.xp);
                }

                this.checkLevelAchievement();
            }
        ...
        initAchievements: function() {
            ...
            this.achievements = {
                A_TRUE_WARRIOR: {
                    id: 1,
                    name: gls("achievements.1.name"),
                    desc: gls("achievements.1.desc")
                },
                INTO_THE_WILD: {
                    id: 2,
                    name: gls("achievements.2.name"),
                    desc: gls("achievements.2.desc")
                },
                ANGRY_RATS: {
                    id: 3,
                    name: gls("achievements.3.name"),
                    desc: gls("achievements.3.desc"),
                ...
                SMALL_TALK: {
                    id: 4,
                    name: gls("achievements.4.name"),
                    desc: gls("achievements.4.desc")
                },
                FAT_LOOT: {
                    id: 5,
                    name: gls("achievements.5.name"),
                    desc: gls("achievements.5.desc")
                },
                UNDERGROUND: {
                    id: 6,
                    name: gls("achievements.6.name"),
                    desc: gls("achievements.6.desc")
                },
                AT_WORLDS_END: {
                    id: 7,
                    name: gls("achievements.7.name"),
                    desc: gls("achievements.7.desc")
                },
                COWARD: {
                    id: 8,
                    name: gls("achievements.8.name"),
                    desc: gls("achievements.8.desc")
                },
                TOMB_RAIDER: {
                    id: 9,
                    name: gls("achievements.9.name"),
                    desc: gls("achievements.9.desc")
                },
                SKULL_COLLECTOR: {
                    id: 10,
                    name: gls("achievements.10.name"),
                    desc: gls("achievements.10.desc"),
                    isCompleted: function() {
                ...
                NINJA_LOOT: {
                    id: 11,
                    name: gls("achievements.11.name"),
                    desc: gls("achievements.11.desc")
                },
                NO_MANS_LAND: {
                    id: 12,
                    name: gls("achievements.12.name"),
                    desc: gls("achievements.12.desc")
                },
                HUNTER: {
                    id: 13,
                    name: gls("achievements.13.name"),
                    desc: gls("achievements.13.desc"),
                    isCompleted: function() {
                ...
                STILL_ALIVE: {
                    id: 14,
                    name: gls("achievements.14.name"),
                    desc: gls("achievements.14.desc"),
                    isCompleted: function() {
                ...
                MEATSHIELD: {
                    id: 15,
                    name: gls("achievements.15.name"),
                    desc: gls("achievements.15.desc"),
                    isCompleted: function() {
                ...
                HOT_SPOT: {
                    id: 16,
                    name: gls("achievements.16.name"),
                    desc: gls("achievements.16.desc")
                },
                HERO: {
                    id: 17,
                    name: gls("achievements.17.name"),
                    desc: gls("achievements.17.desc")
                },
                FOXY: {
                    id: 18,
                    name: gls("achievements.18.name"),
                    desc: gls("achievements.18.desc"),
                    hidden: true
                },
                FOR_SCIENCE: {
                    id: 19,
                    name: gls("achievements.19.name"),
                    desc: gls("achievements.19.desc"),
                    hidden: true
                },
                RICKROLLD: {
                    id: 20,
                    name: gls("achievements.20.name"),
                    desc: gls("achievements.20.desc"),
                    hidden: true
                },
                PVP_BATTLE: {
                    id: 21,
                    name: gls("achievements.21.name"),
                    desc: gls("achievements.21.desc")
                },
                PLAYER_KILLS: {
                    id: 22,
                    name: gls("achievements.22.name"),
                    desc: gls("achievements.22.desc"),
                    isCompleted: function () {
                        return self.storage.getPlayerKillCount() >= 10;
                    },
                    percentCompleted: function() {
                        return self.storage.getPlayerKillCount() / 10;
                    }
                ...
                TEAM_WINS: {
                    id: 23,
                    name: gls("achievements.23.name"),
                    desc: gls("achievements.23.desc"),
                    isCompleted: function () {
                        return self.storage.getTeamWins() >= 10;
                    },
                    percentCompleted: function() {
                        return self.storage.getTeamWins() / 10;
                    }
                ...
                FULL_PLATINUM: {
                    id: 24,
                    name: gls("achievements.24.name"),
                    desc: gls("achievements.24.desc")
                },
                LEVEL_5: {
                    id: 25,
                    name: gls("achievements.25.name"),
                    desc: gls("achievements.25.desc"),
                    isCompleted: function () {
                        return self.storage.getLevel() >= 5;
                    },
                    percentCompleted: function() {
                        return self.storage.getLevel() / 5;
                    }
                ...
                LEVEL_10: {
                    id: 26,
                    name: gls("achievements.26.name"),
                    desc: gls("achievements.26.desc"),
                    isCompleted: function () {
                        return self.storage.getLevel() >= 10;
                    },
                    percentCompleted: function() {
                        return self.storage.getLevel() / 10;
                    }
                ...
                LEVEL_15: {
                    id: 27,
                    name: gls("achievements.27.name"),
                    desc: gls("achievements.27.desc"),
                    isCompleted: function () {
                        return self.storage.getLevel() >= 15;
                    },
                    percentCompleted: function() {
                        return self.storage.getLevel() / 15;
                    }
                ...
                LEVEL_20: {
                    id: 28,
                    name: gls("achievements.28.name"),
                    desc: gls("achievements.28.desc"),
                    isCompleted: function () {
                        return self.storage.getLevel() >= 20;
                    },
                    percentCompleted: function() {
                        return self.storage.getLevel() / 20;
                    }
            ...
            _.each(this.achievements, function(obj) {
                ...
                if(!obj.percentCompleted) {
                    obj.percentCompleted = function() { return 1; };
                    obj.isPercent = false;
                } else {
                    obj.isPercent = true;
                }
        ...
        loadSprite: function(name) {
            if(this.renderer.upscaledRendering) {
                ...
                this.spritesets[this.renderer.imagescale - 1][name] = new Sprite(name, this.renderer.imagescale);
        ...
        run: function(started_callback) {
            ...
            this.setSpriteScale(this.renderer.imagescale);
        ...
        connect: function(started_callback) {
            ...
            this.client.onDispatched(function (host, port) {
                try {
                    if (this.trace) {
                    	window.plugins.analytics.trackPageView("Dispatched");
                    }
                } catch (e) {
            ...
            this.client.onConnected(function () {
                ...
                try {
                    if (this.trace) {
                    	window.plugins.analytics.trackPageView("Connected");
                    }
                } catch (e) {
            ...
            this.client.onWelcome(function (id, name, x, y, hp, minPvpLevel) {

                try {
                    if (this.trace) {
                    	window.plugins.analytics.trackPageView("Welcome");
                    }
                } catch (e) {
                ...
                self.checkWeaponAndArmorAchievement();
                ...
                if(!self.storage.hasAlreadyPlayed()) {
                    ...
                    self.showNotification(gls("chrome.notification.welcome"));
                } else {
                    self.showNotification(gls("chrome.notification.welcomeback"));
                    self.storage.setPlayerName(name);
                }

                //winRtHelper.updateTile(self);
                ...
                self.player.onStep(function() {
                    ...
                    self.checkPVPBattleAchievement();
                ...
                self.client.onPVPChange(function(pvpFlag) {
                    ...
                    if (pvpFlag) {
                        self.showNotification(gls("pvp.area"));
                    }
                    //else {
                ...
                self.client.onPVPWaitChange(function (pvpWaitFlag) {
                    self.player.flagPVPWait(pvpWaitFlag);
                    if (pvpWaitFlag) {
                        if (self.player && self.player.level < self.minPvpLevel) {

                        } else if (!self.pvpFinished) {
                            self.showNotification(gls("pvp.waitingarea"));
                        }
                        self.pvpFinished = false;
                    } 
                    //else {
                    //    self.showNotification("You are entering a Safe Zone!");
                    //}
                ...
                self.client.onPVPFinish(function (redwins, bluewins, type) {

                    self.pvpFinished = true;
                    switch (type) {
                        case Types.PVPFinishType.WIN:
                            self.storage.incrementTeamWins();
                            self.tryUnlockingAchievement("TEAM_WINS");

                            self.showNotification(gls("pvp.won"), 50);
                            break;
                        case Types.PVPFinishType.LOSE:
                            self.showNotification(gls("pvp.lost"), 50);
                            break;
                        case Types.PVPFinishType.DRAW:
                            self.showNotification(gls("pvp.draw"), 50);
                            break;
                        default: //Types.PVPFinishType.NONE
                            break;
                    }
                ...
                self.client.onPVPState(function (redkills, bluekills) {
                    self.redkills = redkills;
                    self.bluekills = bluekills;
                });

                self.client.onPVPTime(function (time) {
                    self.pvpTimeStarted = new Date();
                    self.pvpTimeLeft = time;

                    if (self.player && self.player.level < self.minPvpLevel) {
                        self.showNotification(String.format(gls("pvp.lowlevel"), self.minPvpLevel));
                    } else {
                        //
                    }
                });

                self.client.onPVPTeleport(function (x, y, type) {

                    self.selectedCellVisible = false;
                     
                    //Force the player to stop its movement
                ...
                self.player.onLevelChanged(function () {
                    try {
                        self.client.sendLevel(self.player.getLevel());
                        self.storage.setLevel(self.player.getLevel());
                        self.checkLevelAchievement();
                        self.showNotification(String.format(gls("level.up"), self.player.getLevel(), Types.getMaxLevel()), 100);
                    } catch (e) {
                    }
                });
                ...
                self.client.onPlayerKillMob(function(kind) {
                    ...
                    var key = "killmob." + mobName;
                    var notification = gls(key);
                    ...
                    if (kind === Types.Entities.WARRIOR) {
                        self.storage.incrementPlayerKillCount();
                        self.tryUnlockingAchievement("PLAYER_KILLS");
                    }
                ...
                self.client.onPlayerLevelChanged(function (playerId, level) {
                    var player = self.getEntityById(playerId);
                ...
                self.client.onXP(function (points) {
                    if (self.player) {
                        self.player.incrementXP(points);
                        self.storage.setXP(self.player.getXP());
                    }
                    self.updateBars();
                });
                
                self.client.onPlayerTeam(function (playerId, team) {
                    var player = self.getEntityById(playerId);
                ...
                self.client.onMessageId(function (messageId) {
                    switch (messageId) {
                        case Types.MessageId.PVPTooFew:
                            self.showNotification(gls("pvp.notenoughplayers"), 50);
                            break;
                    }
                });
                ...
                self.client.onDisconnected(function(message, reason) {
                    if(self.player) {
                        self.player.die();
                    }
                    if(self.disconnect_callback) {
                        self.disconnect_callback(message, reason);
                    }
                });
        ...
        isEnemyPlayerAt: function (x, y) {
            var otherPlayer = this.getPlayerAt(x, y);
            if (_.isNull(otherPlayer)) {
                return false;
            }
            return otherPlayer.team !== Types.Team.NEUTRAL && this.player.team !== Types.Team.NEUTRAL && otherPlayer.team !== this.player.team;
        },

        isEnemyPlayer: function (entity) {
            return entity instanceof Player && entity != this.player && this.player.pvpFlag && entity.team !== Types.Team.NEUTRAL && this.player.team !== Types.Team.NEUTRAL && entity.team !== this.player.team;
        },
        ...
        movecursor: function() {
            ...
            if(this.player && !this.renderer.mobile && !this.renderer.tablet) {
                ...
                this.hoveringPlayer = this.isEnemyPlayerAt(x, y);
        ...
        click: function() {
    	    ...
    	    && !this.hoveringPlateauTile) {
        	    ...
        	    if (entity instanceof Mob || this.isEnemyPlayer(entity)) {
            ...
            if(character.isAttacking() && !character.previousTarget) {
                ...
                if(character.canAttack(time)) {
                    if(!isMoving) { // don't hit target if moving to a different tile.
                        ...
                        if(character.hasTarget() && character.target.id === this.playerId && this.player && !this.player.invincible && character instanceof Mob) {
        ...
        startZoningFrom: function(x, y) {
            ...
            if (this.trace) {
                try {
                    var c = c = this.camera;
                    var mapX = parseInt(x / c.gridW);
                    var mapY = parseInt(y / c.gridH);

                    if (this.zoningOrientation === Types.Orientations.RIGHT) {
                        mapX++;
                    }

                    if (this.zoningOrientation === Types.Orientations.DOWN) {
                        mapY++;
                    }
                    var page = "Map" + mapX + "x" + mapY;
        ...
        getTimeText: function () {
            ...
            var interval = Math.max(0, this.pvpTimeLeft - (new Date() - this.pvpTimeStarted));

            var minutes = Math.floor(interval / (60 * 1000));
            var seconds = Math.floor((interval - (minutes * 60 * 1000)) / 1000);
        ...
        updateBars: function() {
            ...
            if (this.player && this.playerxp_callback) {
                this.playerxp_callback(this.player.getXP(), this.player.getXPForCurrentLevel());
            }
        },
        ...
        tryUnlockingAchievement: function(name) {
            ...
            if(name in this.achievements) {
                ...
                if(achievement.isCompleted()) {
                    ...
                    window.gameCenter.reportAchievement("achievements." + achievement.id,
                        function() { },
                        function() { } );
          
                    if (this.storage.unlockAchievement(achievement.id)) {
                    
                        window.plugins.testFlight.passCheckpoint(function() {}, function() {}, "Achievement_" + achievement.id);
                ...
                } else if (achievement.isPercent) {
                    var fraction = achievement.percentCompleted();
                    if (fraction > 0) {
                        var percent = Math.min(99, Math.round(fraction * 100));
                        window.gameCenter.reportPercentAchievement("achievements." + achievement.id, percent,
                                function() { },
                                function() { } );
        ...
        showNotification: function(message, priority) {
            if(this.notification_callback) {
                this.notification_callback(message, priority);
            }
        },
        ...
        checkPVPBattleAchievement: function () {
            var self = this;
            if (self.player.gridX <= 90 && self.player.gridY <= 360 && self.player.gridY > 312) {
                self.tryUnlockingAchievement("PVP_BATTLE");
            }
        },

        checkWeaponAndArmorAchievement: function () {
            var self = this;
            if (self.player && self.player.getWeaponName() === "platinumsword" && self.player.getSpriteName() === "platinumarmor") {
                this.tryUnlockingAchievement("FULL_PLATINUM");
            }
        },

        checkLevelAchievement: function () {
            var self = this;
            if (self.player) {
                this.tryUnlockingAchievement("LEVEL_5");
                this.tryUnlockingAchievement("LEVEL_10");
                this.tryUnlockingAchievement("LEVEL_15");
                this.tryUnlockingAchievement("LEVEL_20");
            }
        },
